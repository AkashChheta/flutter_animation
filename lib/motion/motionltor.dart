...
class Motionlefttoright extends StatefulWidget {
  final Widget child;
  final int duration;
  final Curve curve;
  final count;
  ...
  @override
  Motionlefttorightstate createState() => new Motionlefttorightstate();
}

class Motionlefttorightstate extends State<Motionlefttoright>
