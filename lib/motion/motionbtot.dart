...
class Motionbottomtotop extends StatefulWidget {
  final Widget child;
  final int duration;
  final Curve curve;
  final count;
  ...
  @override
  Motionbottomtotopstate createState() => new Motionbottomtotopstate();
}

class Motionbottomtotopstate extends State<Motionbottomtotop>
