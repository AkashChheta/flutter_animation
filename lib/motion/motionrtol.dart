...
class Motionrighttoleft extends StatefulWidget {
  final Widget child;
  final int duration;
  final Curve curve;
  final count;
  ...
  @override
  Motionrighttoleftstate createState() => new Motionrighttoleftstate();
}

class Motionrighttoleftstate extends State<Motionrighttoleft>
        ...
        builder: (BuildContext context, Widget child) {
          return Transform(
            transform: Matrix4.translationValues(
                _move.value * new Com(context).w, 0.0, 0.0),
            child: child,
          );
        });
  }
