...
class TranslateY extends StatefulWidget {
  final int duration;
  final Widget child;
  final double begin;
  final double end;
  ...
  @override
  Translatestatey createState() => new Translatestatey();
}

class Translatestatey extends State<TranslateY>
  ...
  void initState() {
    ...
    if (Translaterun.onload == widget.run) {
      ...
      _animationmove =
          new Tween(begin: widget.begin, end: widget.end).animate(_controller);
    ...
    return new AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget _widget) {
        return new Transform.translate(
          offset: Offset(0.0, _animationmove.value),
          child: _widget,
        );
      },
    );
