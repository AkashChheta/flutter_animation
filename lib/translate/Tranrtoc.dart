...
class Trighttocenter extends StatefulWidget {
  final Widget child;
  final int duration;
  final runon;
  final runcount;
  ...
  @override
  Trighttocenterstate createState() => new Trighttocenterstate();
}

class Trighttocenterstate extends State<Trighttocenter>
    with SingleTickerProviderStateMixin {
  static AnimationController _controller;
  static Animation _moverighttocenter;
        ...
        builder: (BuildContext context, Widget child) {
          return Transform(
            transform: Matrix4.translationValues(
                _moverighttocenter.value * w, 0.0, 0.0),
            child: child,
          );
        });
  }
