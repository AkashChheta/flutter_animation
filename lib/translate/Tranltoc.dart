...
class Tlefttocenter extends StatefulWidget {
  final Widget child;
  final int duration;
  final runon;
  final runcount;
  ...
  @override
  Tlefttocenterstate createState() => new Tlefttocenterstate();
}

class Tlefttocenterstate extends State<Tlefttocenter>
    with SingleTickerProviderStateMixin {
  static AnimationController _controller;
  static Animation _movelefttocenter;
        ...
        builder: (BuildContext context, Widget child) {
          return Transform(
            transform: Matrix4.translationValues(
                _movelefttocenter.value * w, 0.0, 0.0),
            child: child,
          );
        });
  }
